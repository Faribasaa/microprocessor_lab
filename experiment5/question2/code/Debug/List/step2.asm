...
; 0000 0022 count++;
	...
	MOVW R4,R30
; 0000 0023 
; 0000 0024   if (count==100){
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	CP   R30,R4
	CPC  R31,R5
	BRNE _0x3
; 0000 0025     if (PINC.2 == 0 ){      //rotete clockwise
	SBIC 0x13,2
	RJMP _0x4
; 0000 0026 
; 0000 0027             //step1
; 0000 0028             PORTA=0x09;
	RCALL SUBOPT_0x0
...
; 0000 0040 
; 0000 0041 
; 0000 0042    if (PINC.2 == 1){       //rotate anticlockwise
_0x4:
	SBIS 0x13,2
	RJMP _0x5
; 0000 0043 
; 0000 0044             PORTA=0x05;
	RCALL SUBOPT_0x3
...
; .FSTART _main
; 0000 0066 
; 0000 0067 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(15)
	OUT  0x1A,R30
...
; 0000 0069 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 006A PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (1<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(4)
	OUT  0x15,R30
; 0000 006B 
; 0000 006C // Timer/Counter 0 initialization
; 0000 006D // Clock source: System Clock
; 0000 006E // Clock value: 4000.000 kHz
; 0000 006F // Mode: Normal top=0xFF
; 0000 0070 // OC0 output: Disconnected
; 0000 0071 // Timer Period: 0.05 ms
; 0000 0072 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(1)
	OUT  0x33,R30
; 0000 0073 TCNT0=0x38;
	LDI  R30,LOW(56)
	OUT  0x32,R30
; 0000 0074 OCR0=0x00;
	LDI  R30,LOW(0)
